  ...
  useEffect(() => {
    axios
      .get(
        ...
        `http://api.weatherapi.com/v1/current.json?key=2d51565d96084b18afe193249241804&q=${targetName}&aqi=no`
      )
      .then((res) => {
